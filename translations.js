const translations = {
    ...
    zh: {
        ...
        feature_banner_text: "GOAT 系列记录了比特币的决定性时刻，从创世到今天。<br>基于 RGB 智能合约和即时原子交换构建，GOAT 是比特币的首创。就像 CryptoPunks 之于以太坊。",
        feature_banner_subtext: "这个系列标志着比特币第三季。一个转折点，比特币智能合约使比特币和闪电网络上的稳定币和现实世界资产代币化成为可能。",
        ...
        pill_space: "太空",
        // Nakamoto Specific
        nakamoto_subtitle: "应许之 GOAT",
        nakamoto_desc: "金色夜晚的幻影，中本聪 GOAT 照亮了比特币第三季的巨大潜力。<br>为比特币传奇和 RGB 英雄打造的稀有收藏。",
        nakamoto_mint_title: "精英铸造",
        // Space Specific
        space_subtitle: "最后的边界 ~ 达到新高度",
        space_desc: "引领大规模采用的先锋，太空 GOAT 将比特币智能合约的力量传播到宇宙的无限尽头。",
