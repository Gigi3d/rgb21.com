const translations = {
    en: {
        ...
        feature_banner_subtext: "Built on RGB smart contracts with instant atomic swaps, GOAT is a first—much like CryptoPunks was for Ethereum. Bitcoin Season 3 has arrived. Powered by Bitmask and the DIBA marketplace, smart contracts on the world's most secure network are now a reality. Join the pioneers shaping what comes next.",
        pill_label: "SUMMON:",
        standard: "Standard",
        classic: "Classic",
    ...
    zh: {
        ...
        feature_banner_subtext: "基于 RGB 智能合约和即时原子交换构建，GOAT 是一个先驱——就像 CryptoPunks 之于以太坊。比特币第三季已经到来。在 Bitmask 和 DIBA 市场的支持下，世界上最安全网络上的智能合约现已成为现实。加入塑造未来的先行者。",
        pill_label: "召唤:",
        standard: "标准版",
        classic: "经典版",
