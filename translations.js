const translations = {
    en: {
        ...
        feature_banner_text: "The GOAT collection is a story of the Bitcoin Movement, bringing to light critical events in Bitcoin history since genesis. It signals an expected mass exodus of global finance from legacy systems to the Bitcoin Standard, led by $USDT issuance on Bitcoin.",
        feature_banner_subtext: "This is the first collection using RGB smart contracts and instant atomic swaps—it is historic, just like the CryptoPunks were for Ethereum. The dawn of Bitcoin Season 3 is here. Powered by Bitmask and the DIBA marketplace, we are ushering in a golden age of smart contracts that redefine ownership on the most robust network ever created. Join a community of pioneers planting their flags in the stars, as we push the boundaries of what's possible in the decentralized frontier.",
        pill_label: "SUMMON:",
        standard: "Standard",
        classic: "Classic",
    ...
    zh: {
        ...
        feature_banner_text: "GOAT 系列是比特币运动的故事，揭示了自创世以来比特币历史中的关键事件。它标志着全球金融从传统系统向比特币标准的预期大规模迁移，由比特币上的 $USDT 发行引领。",
        feature_banner_subtext: "这是第一个使用 RGB 智能合约和即时原子交换的系列，具有历史意义，就像 CryptoPunks 之于以太坊智能合约一样。比特币第三季的曙光已经到来。在 Bitmask 和 DIBA 市场的支持下，我们正在开启智能合约的黄金时代，重新定义这个有史以来最强大网络上的所有权。加入先驱社区，在星海中插下旗帜，共同挑战去中心化前沿的无限可能。",
        pill_label: "召唤:",
        standard: "标准版",
        classic: "经典版",
