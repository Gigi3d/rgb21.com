const translations = {
    en: {
        ...
        feature_banner_text: "The GOAT collection chronicles Bitcoin's defining moments, from genesis to the present day. As global finance shifts toward the Bitcoin Standard, marked by $USDT issuing directly on Bitcoin, this collection captures the turning point.",
        feature_banner_subtext: "Built on RGB smart contracts with instant atomic swaps, GOAT is a first. Much like CryptoPunks was for Ethereum. Bitcoin Season 3 has arrived. Powered by Bitmask and the DIBA marketplace, smart contracts on the world's most secure network are now a reality.",
        ...
        nakamoto_desc: "A phantom of the golden night, Nakamoto GOAT lights up at the massive potential of Bitcoin Season 3. A world where stablecoins and Real-World Asset Tokenization as secured by Bitcoin",
