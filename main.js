const translations = {
    en: {
        ...
        feature_banner_text: "The GOAT collection chronicles Bitcoin's defining moments, from genesis to the present day.<br>Built on RGB smart contracts with instant atomic swaps, GOAT is a first for Bitcoin. Much like CryptoPunks was for Ethereum.",
        feature_banner_subtext: "This collection marks Bitcoin Season 3. A turning point where Bitcoin smartcontracts enable stablecoins and Real-World Asset Tokenization  on Bitcoin and the Lightning network.",
    ...
    zh: {
        ...
        faq_title: "常见问题解答",
        feature_banner_title: "Bitcoin<br>Season&nbsp;3<br>GOAT",
        feature_banner_text: "GOAT 系列记录了比特币的决定性时刻，从创世到今天。随着全球金融转向比特币本位，以 $USDT 直接在比特币上发行为标志，这个系列捕捉了这一转折点。",
        feature_banner_subtext: "基于 RGB 智能合约和即时原子交换构建，GOAT 是一个先驱。就像 CryptoPunks 之于以太坊。比特币第三季已经到来。在 Bitmask 和 DIBA 市场的支持下，世界上最安全网络上的智能合约现已成为现实。",
        feature_banner_cta: "加入塑造未来的先行者。",
        pill_label: "召唤:",
        standard: "标准版",
        classic: "经典版",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    startCountdown('space-goat-timer-classic', 'January 21, 2025 00:00:00');
    startCountdown('space-goat-wl-timer', 'January 21, 2025 00:00:00');
    startCountdown('space-goat-wl-timer-classic', 'January 21, 2025 00:00:00');
    startCountdown('nakamoto-timer', 'January 21, 2025 00:00:00');
    startCountdown('nakamoto-timer-classic', 'January 21, 2025 00:00:00');
    startCountdown('goddess-timer', 'January 12, 2025 00:00:00');
    startCountdown('goddess-timer-classic', 'January 12, 2025 00:00:00');
