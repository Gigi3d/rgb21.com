const translations = {
    en: {
        ...
        feature_banner_title: "The Future<br>of Bitcoin<br>GOAT",
        feature_banner_text: "Designed for the era of true digital ownership. Built on RGB smart contracts. Atomic swaps on Bitcoin. Scaled for the world. This is the first of its kind. A new standard for digital art.",
        feature_banner_subtext: "This is Bitcoin Season 3. A turning point enabled by client side validated assets. Where smart contracts bring stablecoins and real world assets to the Lightning network.",
        feature_banner_cta: "Experience the evolution.",
        pill_label: "SUMMON:",
        standard: "Standard",
        classic: "Classic",
        ...
        pill_space: "Space",
        // Nakamoto Specific
        nakamoto_subtitle: "THE BLUEPRINT",
        ...
        nakamoto_desc: "A phantom in the night. The Nakamoto GOAT represents the vast potential of scriptless atomic swaps. Rare. Powerful. Built for those who believe in the future of Bitcoin.",
        ...
        // Queen Specific
        queen_subtitle: "A Legacy of Kindness",
        queen_desc: "A gift to the community. 210 unique pieces of history. Testing the RGB infrastructure and birthing Bitcoin Season 3. Technical excellence meets kindness.",
    ...
    zh: {
        ...
        feature_banner_text: "为真正的数字所有权时代而设计。基于 RGB 智能合约构建。比特币上的原子交换。为全球扩展而生。这是首创之举，是数字艺术的新标准。",
        feature_banner_subtext: "这是比特币第三季。由客户端验证资产开启的转折点。智能合约将在此把稳定币和现实世界资产带入闪电网络。",
        feature_banner_cta: "体验这场进化。",
        pill_label: "召唤:",
        standard: "标准版",
        classic: "经典版",
        ...
        faq_a10: "<div class='faq-rich-content'>\
            <p>BitMask 是您通往非托管金融的门户。一个为新比特币经济而生的钱包，支持在比特币上直接实现客户端验证资产和智能合约。</p>\
        ...
        faq_q3: "RGB 铭文",
        faq_a3: "<div class='faq-rich-content'><p>未来，GOAT 持有者可以安全地在链上保护他们的传承。RGB 铭文是比特币上经过 <span class='highlight'>客户端验证</span> 的智能合约，支持可扩展且私密的数字资产。</p></div>",
...
class LanguageManager {
    ...
    updateMetaTags() {
        ...
        // Update Title
        let titleKey = '';
        if (document.body.classList.contains('mode-nakamoto-goat')) titleKey = 'meta_title_nakamoto';
        else if (document.body.classList.contains('mode-space-goat')) titleKey = 'meta_title_space';
        else if (document.body.classList.contains('mode-queen-goat')) titleKey = 'meta_title_queen';
        ...
        if (ogDesc && langData.meta_description) ogDesc.setAttribute('content', langData.meta_description);

        const twDesc = document.querySelector('meta[property="twitter:description"]');
        if (twDesc && langData.meta_description) twDesc.setAttribute('content', langData.meta_description);
